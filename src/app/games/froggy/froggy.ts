...
const INITIAL_VEHICLES: IVehicle[] = [
  ...
  { x: 150, y: 330, width: 80, height: 40, speed: -3, sprite: 'coche-2' },
  { x: 450, y: 330, width: 80, height: 40, speed: -3, sprite: 'coche-3' },
  { x: 750, y: 330, width: 80, height: 40, speed: -3, sprite: 'coche-1' },
  ...
  { x: 150, y: 420, width: 80, height: 40, speed: -5, sprite: 'coche-1' },
  { x: 450, y: 420, width: 80, height: 40, speed: -5, sprite: 'coche-2' },
  { x: 750, y: 420, width: 80, height: 40, speed: -5, sprite: 'coche-3' },
